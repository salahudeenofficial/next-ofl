const ContactUs = () => {
    return (
      <div   id="contact-us" className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="w-full max-w-xl p-8">
          <h1 className="text-3xl font-bold text-center text-blue-800 mb-7 md:mb-2">CONTACT US</h1>
          <p className="hidden md:block mt-12 text-2sm text-center font-bold text-black mb-5">Thank you for choosing us,</p>
          <form>
            <div className="mb-4">
              <input
                type="text"
          ...
          <div className="mt-12 flex justify-around text-black">
            ...
            <svg width="30" height="30" viewBox="0 0 35 34" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9.7455 3.34985V5.71534L2.30005 10.5626V30.6499H32.0819V10.5626L24.6364 5.71534V3.34985H9.7455ZM12.2273 5.83167H22.1546V15.3712L17.191 18.5898L12.2273 15.3712V5.83167ZM13.4682 8.31349V10.7953H20.9137V8.31349H13.4682ZM9.7455 8.6625V13.7425L5.82888 11.2219L9.7455 8.6625ZM24.6364 8.6625L28.553 11.2219L24.6364 13.7425V8.6625ZM13.4682 12.0362V14.518H20.9137V12.0362H13.4682ZM4.78187 13.5098L17.191 21.5369L29.6 13.5098V28.168H4.78187V13.5098Z" fill="black"/>
            </svg>
